...
(function (p, o) {
    function E(a, b) {
        return function () {
            ...
            try {
                ...
                c.plugin.errors.push({plugin: b, thrown: d, source: a.toString()});
    ...
    if (o.addEventListener) {
        var t = Array.prototype, y = Object.prototype, z = t.forEach, A = t.slice, x = y.hasOwnProperty, B = y.toString, F = p.Popcorn, v = [], C = false, u = {events: {hash: {}, apis: {}}}, D = function () {
            return p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame ||
                p.oRequestAnimationFrame || p.msRequestAnimationFrame || function (a) {
                p.setTimeout(a, 16)
            }
        }(), c = function (a, b) {
        ...
        c.isSupported = true;
        c.instances = [];
        c.p = c.prototype = {init: function (a, b) {
            var d, e = this;
            if (typeof a === "function")if (o.readyState === "complete")a(o, c); else {
                v.push(a);
                if (!C) {
                    C = true;
                    var f = function () {
                ...
                this.data = {running: {cue: []}, timeUpdate: c.nop, disabled: {}, events: {}, hooks: {}, history: [], state: {volume: this.media.volume}, trackRefs: {},
                    trackEvents: {byStart: [
                        {start: -1, end: -1}
                    ], byEnd: [
                        {start: -1, end: -1}
                    ], animating: [], startIndex: 0, endIndex: 0, previousUpdateTime: -1}};
                ...
                var i = function () {
                    ...
                    c.addTrackEvent(e, {start: k, end: k});
        ...
        c.extend(c, {noConflict: function (a) {
            if (a)p.Popcorn =
                F;
            return c
        }, error: function (a) {
            ...
            var b = {}, d = o.documentElement, e = o.body, f, h, i;
            ...
            return c.extend({}, b, {top: f, left: h})
            ...
            var b =
                a.data.events, d = a.data.trackEvents, e, f, h, i;
            for (f in b) {
                e = b[f];
                ...
                function (b) {
                    a[b] = function (d) {
                        ...
                        if (d != null) {
                            e = this.media[b];
                            this.media[b] = d;
                            e !== d && this.emit("attrchange", {attribute: b, previousValue: e, currentValue: d});
                            return this
                        }
                        return this.media[b]
                    }
        ...
        c.extend(c.p, {roundTime: function () {
            return Math.round(this.media.currentTime)
        },
            exec: function (a, b, d) {
                var e = arguments.length, f, h;
                try {
                ...
                if (typeof a === "number" && e === 2) {
                    ...
                    b = a;
                    a = c.guid("cue")
                } else if (e === 1)b = -1; else if (f = this.getTrackEvent(a)) {
                ...
                c.addTrackEvent(this,
                    {id: a, start: b, end: b + 1, _running: false, _natives: {start: d || c.nop, end: c.nop, type: "cue"}});
                return this
            }, mute: function (a) {
        ...
        c.events = {isNative: function (a) {
            ...
            return h
        }, all: c.Events.Natives.split(/\s+/g), fn: {trigger: function (a, b) {
            var d;
            ...
            var d = this, e = true, f = c.events.hooks[a], h;
            ...
            return this
        }}, hooks: {canplayall: {bind: "canplaythrough", add: function (a, b) {
            var d = false;
            if (this.media.readyState) {
                b.call(this, a);
                d = true
            }
            this.data.hooks.canplayall = {fired: d}
        ...
        c.addTrackEvent = function (a, b) {
            ...
            var f = a.data.trackEvents.byStart, h = a.data.trackEvents.byEnd, i;
            ...
            if (e) {
                ...
                a.emit(e, {id: b.id, previousValue: {time: d.start, fn: d._natives.start}, currentValue: {time: b.start, fn: b._natives.start}})
            }
        };
        ...
        c.removeTrackEvent = function (a, b) {
            ...
            for (h =
                     0; h < f; h++)a.data.history[h] !== b && g.push(a.data.history[h]);
            a.data.history = g;
        ...
        c.getLastTrackEventId =
            function (a) {
                return a.data.history[a.data.history.length - 1]
            };
        c.timeUpdate = function (a, b) {
            var d = a.media.currentTime, e = a.data.trackEvents.previousUpdateTime, f = a.data.trackEvents, h = f.endIndex, i = f.startIndex, k = f.byStart.length, n = f.byEnd.length, m = c.registryByName, j, g, l;
            if (e <= d) {
                    ...
                    if (!e || m[g] || a[g]) {
                        if (j._running === true) {
                            ...
                            if (!a.data.disabled[g]) {
                                e.end.call(a, b, j);
                                a.emit("trackend",
                                    c.extend({}, j, {plugin: g, type: "trackend"}))
                            }
                        }
                        h++
                    } else {
                ...
                for (; f.byStart[i] && f.byStart[i].start <= d;) {
                    ...
                    if (!e || m[g] || a[g]) {
                        if (j.end > d && j._running === false) {
                            ...
                            if (!a.data.disabled[g]) {
                                e.start.call(a, b, j);
                                a.emit("trackstart", c.extend({}, j, {plugin: g, type: "trackstart"}))
                            }
                        }
                        i++
                    } else {
                ...
                for (; f.byStart[i] && f.byStart[i].start > d;) {
                    ...
                    if (!e || m[g] || a[g]) {
                        if (j._running === true) {
                            ...
                            if (!a.data.disabled[g]) {
                                e.end.call(a, b, j);
                                a.emit("trackend", c.extend({}, j, {plugin: g, type: "trackend"}))
                            }
                        }
                        i--
                    } else {
        ...
        c.extend(c.p, {getTrackEvents: function () {
        ...
        c.plugin = function (a, b, d) {
            if (c.protect.natives.indexOf(a.toLowerCase()) >= 0)c.error("'" + a + "' is a protected function name"); else {
                var e = ["start", "end"], f = {}, h = typeof b === "function", i = ["_setup", "_teardown", "start", "end", "frame"], k = function (j, g) {
                    j = j || c.nop;
                    g = g ||
                        c.nop;
                    return function () {
                ...
                var n = function (j, g) {
                    ...
                    l._teardown = k(function () {
                        var q = A.call(arguments), r = this.data.running[l.type];
                        q.unshift(null);
                ...
                c.p[a] = f[a] = function (j, g) {
                    var l;
                    if (j && !g)g = j; else if (l = this.getTrackEvent(j)) {
                        g = c.extend({}, l, g);
                        c.addTrackEvent(this, g);
                        return this
                    } else g.id = j;
                ...
                d && c.extend(b, {manifest: d});
                var m = {fn: f[a], definition: b, base: b, parents: [], name: a};
                c.registry.push(c.extend(f, m, {type: a}));
        ...
        c.removePlugin = function (a, b) {
            ...
            var f = a.data.trackEvents.animating, h, i;
            h = 0;
        ...
        var G = /^(?:\.|#|\[)/;
        c.dom = {debug: false, find: function (a, b) {
            var d = null;
            a = a.trim();
            b =
                b || o;
        ...
        var H = /\?/, I = {url: "", data: "", dataType: "", success: c.nop, type: "GET", async: true, xhr: function () {
            return new p.XMLHttpRequest
        }};
        c.xhr = function (a) {
            a.dataType = a.dataType && a.dataType.toLowerCase() || null;
            if (a.dataType && (a.dataType === "jsonp" || a.dataType === "script"))c.xhr.getJSONP(a.url, a.success, a.dataType === "script"); else {
                a = c.extend({}, I, a);
                a.ajax = a.xhr();
                if (a.ajax) {
                    if (a.type ===
        ...
        c.xhr.httpData = function (a) {
            ...
            a.ajax.onreadystatechange = function () {
                if (a.ajax.readyState === 4) {
                    ...
                    b = {xml: a.ajax.responseXML, text: a.ajax.responseText, json: d};
                    if (!b.xml || !b.xml.documentElement) {
                        b.xml = null;
                        try {
                            e = new DOMParser;
                            f = e.parseFromString(a.ajax.responseText, "text/xml");
                            if (!f.getElementsByTagName("parsererror").length)b.xml =
                                f
                        } catch (i) {
                        }
                    }
        ...
        c.xhr.getJSONP = function (a, b, d) {
            var e = o.head || o.getElementsByTagName("head")[0] || o.documentElement, f = o.createElement("script"), h = false, i = [];
            i = /(=)\?(?=&|$)|\?\?/;
            var k, n;
            if (!d) {
                n = a.match(/(callback=[^&]*)/);
        ...
        c.util = {toSeconds: function (a, b) {
            var d = /^([0-9]+:){0,2}[0-9]+([.;][0-9]+)?$/, e, f, h;
            ...
            e = d[0];
            return{1: parseFloat(e, 10), 2: parseInt(e, 10) * 60 + parseFloat(d[1], 10), 3: parseInt(e, 10) * 3600 + parseInt(d[1], 10) * 60 + parseFloat(d[2], 10)}[d.length || 1]
        }};
        c.p.cue = c.p.exec;
        c.protect = {natives: function (a) {
        ...
        c.forEach({listen: "on", unlisten: "off",
            trigger: "emit", exec: "cue"}, function (a, b) {
            var d = c.p[b];
            c.p[b] = function () {
        ...
        for (t = "byId forEach extend effects error guid sizeOf isArray nop position disable enable destroyaddTrackEvent removeTrackEvent getTrackEvents getTrackEvent getLastTrackEventId timeUpdate plugin removePlugin compose effect xhr getJSONP getScript".split(/\s+/); t.length;)p.Popcorn[t.shift()] =
            function () {
            }
    }
